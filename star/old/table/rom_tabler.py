...
data = pd.read_table("periods_rom", names = ['name', 'period', 'amp'], sep = "&",header = None, engine="python")
...
first = data.iloc[0:82]

second = data.iloc[82:162]
