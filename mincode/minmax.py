...
plt.scatter(temps,masses,cmap = reversed_color_map,c=sigma_mins, marker='s')
...
print("Min Sig: ", data.temp[min_index], data.mass[min_index], min(sigma_mins), "(could be unreliable, truncating error")
print("Max Freq: ", temps[max_index], masses[max_index], max(freq))
"""
plt.figure(100, figsize=(8,6))
#plt.scatter(data.temp,data.mass,c=data.sigma)
